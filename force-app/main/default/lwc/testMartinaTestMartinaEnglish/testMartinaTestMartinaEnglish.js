...
import { OMNIDEF } from './testMartinaTestMartinaEnglish_def.js';
import tmpl from './testMartinaTestMartinaEnglish.html';
import tmpl_nds from './testMartinaTestMartinaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testMartinaTestMartinaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

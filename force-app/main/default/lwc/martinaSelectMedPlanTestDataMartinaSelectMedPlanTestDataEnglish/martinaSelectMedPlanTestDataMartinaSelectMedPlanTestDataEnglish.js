...
import { OMNIDEF } from './martinaSelectMedPlanTestDataMartinaSelectMedPlanTestDataEnglish_def.js';
import tmpl from './martinaSelectMedPlanTestDataMartinaSelectMedPlanTestDataEnglish.html';
import tmpl_nds from './martinaSelectMedPlanTestDataMartinaSelectMedPlanTestDataEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class martinaSelectMedPlanTestDataMartinaSelectMedPlanTestDataEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

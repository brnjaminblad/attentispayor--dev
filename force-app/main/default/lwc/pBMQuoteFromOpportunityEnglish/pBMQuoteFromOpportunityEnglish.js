...
import { OMNIDEF } from './pBMQuoteFromOpportunityEnglish_def.js';
import tmpl from './pBMQuoteFromOpportunityEnglish.html';
import tmpl_nds from './pBMQuoteFromOpportunityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pBMQuoteFromOpportunityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

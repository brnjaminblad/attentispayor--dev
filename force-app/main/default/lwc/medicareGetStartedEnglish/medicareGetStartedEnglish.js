...
import { OMNIDEF } from './medicareGetStartedEnglish_def.js';
import tmpl from './medicareGetStartedEnglish.html';
import tmpl_nds from './medicareGetStartedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareGetStartedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

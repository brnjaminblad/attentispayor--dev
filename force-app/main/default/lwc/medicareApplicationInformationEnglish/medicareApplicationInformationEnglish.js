...
import { OMNIDEF } from './medicareApplicationInformationEnglish_def.js';
import tmpl from './medicareApplicationInformationEnglish.html';
import tmpl_nds from './medicareApplicationInformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareApplicationInformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

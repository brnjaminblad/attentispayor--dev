...
import { OMNIDEF } from './healthSherpaGet_StartedEnglish_def.js';
import tmpl from './healthSherpaGet_StartedEnglish.html';
import tmpl_nds from './healthSherpaGet_StartedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthSherpaGet_StartedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

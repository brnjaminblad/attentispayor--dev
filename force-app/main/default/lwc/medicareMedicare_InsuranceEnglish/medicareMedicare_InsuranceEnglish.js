...
import { OMNIDEF } from './medicareMedicare_InsuranceEnglish_def.js';
import tmpl from './medicareMedicare_InsuranceEnglish.html';
import tmpl_nds from './medicareMedicare_InsuranceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareMedicare_InsuranceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

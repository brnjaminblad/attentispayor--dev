...
import { OMNIDEF } from './martinaQuoteQuoteTestEnglish_def.js';
import tmpl from './martinaQuoteQuoteTestEnglish.html';
import tmpl_nds from './martinaQuoteQuoteTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class martinaQuoteQuoteTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

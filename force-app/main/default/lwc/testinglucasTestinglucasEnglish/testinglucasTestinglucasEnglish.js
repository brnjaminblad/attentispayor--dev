...
import { OMNIDEF } from './testinglucasTestinglucasEnglish_def.js';
import tmpl from './testinglucasTestinglucasEnglish.html';
import tmpl_nds from './testinglucasTestinglucasEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testinglucasTestinglucasEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

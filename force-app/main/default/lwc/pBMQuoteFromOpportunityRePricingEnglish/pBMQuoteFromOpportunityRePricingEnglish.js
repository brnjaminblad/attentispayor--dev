...
import { OMNIDEF } from './pBMQuoteFromOpportunityRePricingEnglish_def.js';
import tmpl from './pBMQuoteFromOpportunityRePricingEnglish.html';
import tmpl_nds from './pBMQuoteFromOpportunityRePricingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pBMQuoteFromOpportunityRePricingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

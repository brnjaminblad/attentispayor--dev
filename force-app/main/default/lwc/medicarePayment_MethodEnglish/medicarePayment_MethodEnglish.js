...
import { OMNIDEF } from './medicarePayment_MethodEnglish_def.js';
import tmpl from './medicarePayment_MethodEnglish.html';
import tmpl_nds from './medicarePayment_MethodEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicarePayment_MethodEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './medicareEnrollEnglish_def.js';
import tmpl from './medicareEnrollEnglish.html';
import tmpl_nds from './medicareEnrollEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareEnrollEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

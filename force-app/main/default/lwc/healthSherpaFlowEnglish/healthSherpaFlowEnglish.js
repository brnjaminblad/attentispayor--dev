...
import { OMNIDEF } from './healthSherpaFlowEnglish_def.js';
import tmpl from './healthSherpaFlowEnglish.html';
import tmpl_nds from './healthSherpaFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthSherpaFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

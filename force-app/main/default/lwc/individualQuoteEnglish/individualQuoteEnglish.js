...
import { OMNIDEF } from './individualQuoteEnglish_def.js';
import tmpl from './individualQuoteEnglish.html';
import tmpl_nds from './individualQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class individualQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

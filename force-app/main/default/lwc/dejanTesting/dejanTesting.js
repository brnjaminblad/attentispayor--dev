...
import { interpolateWithRegex, interpolateKeyValue } from "vlocity_ins/flexCardUtility";
...
export default class DejanTesting extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)) {
    @api debug;
    @api recordId;
    @track omniSupportKey;
    @track record;

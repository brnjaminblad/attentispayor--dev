...
export default class PlanListView extends OmniscriptBaseMixin(LightningElement) {
    ...
    connectedCallback() {
       // this.template.querySelector(".slds-progress__list").style.width = "0";
    ...
    renderedCallback() {
        this.document.querySelector(".slds-progress__list").style.width = "0";

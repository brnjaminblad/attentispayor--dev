...
import { OMNIDEF } from './medicareReview_Your_QuoteEnglish_def.js';
import tmpl from './medicareReview_Your_QuoteEnglish.html';
import tmpl_nds from './medicareReview_Your_QuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareReview_Your_QuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

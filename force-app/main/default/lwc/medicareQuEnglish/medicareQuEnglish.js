...
import { OMNIDEF } from './medicareQuEnglish_def.js';
import tmpl from './medicareQuEnglish.html';
import tmpl_nds from './medicareQuEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareQuEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

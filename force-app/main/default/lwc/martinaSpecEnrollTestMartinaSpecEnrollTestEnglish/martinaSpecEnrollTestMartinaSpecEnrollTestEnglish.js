...
import { OMNIDEF } from './martinaSpecEnrollTestMartinaSpecEnrollTestEnglish_def.js';
import tmpl from './martinaSpecEnrollTestMartinaSpecEnrollTestEnglish.html';
import tmpl_nds from './martinaSpecEnrollTestMartinaSpecEnrollTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class martinaSpecEnrollTestMartinaSpecEnrollTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

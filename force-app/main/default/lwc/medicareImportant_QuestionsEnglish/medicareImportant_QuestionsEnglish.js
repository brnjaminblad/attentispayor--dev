...
import { OMNIDEF } from './medicareImportant_QuestionsEnglish_def.js';
import tmpl from './medicareImportant_QuestionsEnglish.html';
import tmpl_nds from './medicareImportant_QuestionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareImportant_QuestionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

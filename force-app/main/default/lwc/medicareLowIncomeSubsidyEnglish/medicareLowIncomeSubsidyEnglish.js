...
import { OMNIDEF } from './medicareLowIncomeSubsidyEnglish_def.js';
import tmpl from './medicareLowIncomeSubsidyEnglish.html';
import tmpl_nds from './medicareLowIncomeSubsidyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareLowIncomeSubsidyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

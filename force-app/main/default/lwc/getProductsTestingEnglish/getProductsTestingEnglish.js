...
import { OMNIDEF } from './getProductsTestingEnglish_def.js';
import tmpl from './getProductsTestingEnglish.html';
import tmpl_nds from './getProductsTestingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class getProductsTestingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

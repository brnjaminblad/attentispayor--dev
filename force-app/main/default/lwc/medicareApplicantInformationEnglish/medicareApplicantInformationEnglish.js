...
import { OMNIDEF } from './medicareApplicantInformationEnglish_def.js';
import tmpl from './medicareApplicantInformationEnglish.html';
import tmpl_nds from './medicareApplicantInformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareApplicantInformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

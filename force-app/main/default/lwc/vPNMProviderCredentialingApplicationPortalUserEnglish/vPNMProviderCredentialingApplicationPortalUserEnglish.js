...
import { OMNIDEF } from './vPNMProviderCredentialingApplicationPortalUserEnglish_def.js';
import tmpl from './vPNMProviderCredentialingApplicationPortalUserEnglish.html';
import tmpl_nds from './vPNMProviderCredentialingApplicationPortalUserEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vPNMProviderCredentialingApplicationPortalUserEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

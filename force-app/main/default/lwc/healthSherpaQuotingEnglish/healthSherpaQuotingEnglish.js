...
import { OMNIDEF } from './healthSherpaQuotingEnglish_def.js';
import tmpl from './healthSherpaQuotingEnglish.html';
import tmpl_nds from './healthSherpaQuotingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthSherpaQuotingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

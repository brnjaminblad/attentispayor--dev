...
import { OMNIDEF } from './martinaSelectMedPlanTestQuoteSelectMedPlanEnglish_def.js';
import tmpl from './martinaSelectMedPlanTestQuoteSelectMedPlanEnglish.html';
import tmpl_nds from './martinaSelectMedPlanTestQuoteSelectMedPlanEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class martinaSelectMedPlanTestQuoteSelectMedPlanEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './medicareApplication_CongratulationsEnglish_def.js';
import tmpl from './medicareApplication_CongratulationsEnglish.html';
import tmpl_nds from './medicareApplication_CongratulationsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareApplication_CongratulationsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './hSQuoteAndEnrollEnglish_def.js';
import tmpl from './hSQuoteAndEnrollEnglish.html';
import tmpl_nds from './hSQuoteAndEnrollEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class hSQuoteAndEnrollEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

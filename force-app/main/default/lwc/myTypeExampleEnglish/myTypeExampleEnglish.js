...
import { OMNIDEF } from './myTypeExampleEnglish_def.js';
import tmpl from './myTypeExampleEnglish.html';
import tmpl_nds from './myTypeExampleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class myTypeExampleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './healthSherpaSelectPlansEnglish_def.js';
import tmpl from './healthSherpaSelectPlansEnglish.html';
import tmpl_nds from './healthSherpaSelectPlansEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthSherpaSelectPlansEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './dejantestingDejantestingEnglish_def.js';
import tmpl from './dejantestingDejantestingEnglish.html';
import tmpl_nds from './dejantestingDejantestingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dejantestingDejantestingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

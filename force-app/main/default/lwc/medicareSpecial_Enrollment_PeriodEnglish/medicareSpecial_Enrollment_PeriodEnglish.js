...
import { OMNIDEF } from './medicareSpecial_Enrollment_PeriodEnglish_def.js';
import tmpl from './medicareSpecial_Enrollment_PeriodEnglish.html';
import tmpl_nds from './medicareSpecial_Enrollment_PeriodEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareSpecial_Enrollment_PeriodEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

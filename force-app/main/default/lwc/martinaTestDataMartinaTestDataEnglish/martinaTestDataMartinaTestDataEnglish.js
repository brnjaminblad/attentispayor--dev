...
import { OMNIDEF } from './martinaTestDataMartinaTestDataEnglish_def.js';
import tmpl from './martinaTestDataMartinaTestDataEnglish.html';
import tmpl_nds from './martinaTestDataMartinaTestDataEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class martinaTestDataMartinaTestDataEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './healthSherpaLowIncomeSubsidyEnglish_def.js';
import tmpl from './healthSherpaLowIncomeSubsidyEnglish.html';
import tmpl_nds from './healthSherpaLowIncomeSubsidyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthSherpaLowIncomeSubsidyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

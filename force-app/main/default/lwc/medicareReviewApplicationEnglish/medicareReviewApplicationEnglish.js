...
import { OMNIDEF } from './medicareReviewApplicationEnglish_def.js';
import tmpl from './medicareReviewApplicationEnglish.html';
import tmpl_nds from './medicareReviewApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareReviewApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

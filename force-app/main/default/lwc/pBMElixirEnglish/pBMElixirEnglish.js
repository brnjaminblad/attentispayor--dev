...
import { OMNIDEF } from './pBMElixirEnglish_def.js';
import tmpl from './pBMElixirEnglish.html';
import tmpl_nds from './pBMElixirEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pBMElixirEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './martinaTestsDataMartinaTestsDataEnglish_def.js';
import tmpl from './martinaTestsDataMartinaTestsDataEnglish.html';
import tmpl_nds from './martinaTestsDataMartinaTestsDataEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class martinaTestsDataMartinaTestsDataEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './medicareImportant_InformationEnglish_def.js';
import tmpl from './medicareImportant_InformationEnglish.html';
import tmpl_nds from './medicareImportant_InformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareImportant_InformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

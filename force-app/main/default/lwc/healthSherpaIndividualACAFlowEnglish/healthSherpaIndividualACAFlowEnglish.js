...
import { OMNIDEF } from './healthSherpaIndividualACAFlowEnglish_def.js';
import tmpl from './healthSherpaIndividualACAFlowEnglish.html';
import tmpl_nds from './healthSherpaIndividualACAFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class healthSherpaIndividualACAFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

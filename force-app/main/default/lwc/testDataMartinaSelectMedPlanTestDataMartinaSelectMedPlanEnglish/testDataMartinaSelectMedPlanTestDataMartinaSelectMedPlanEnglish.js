...
import { OMNIDEF } from './testDataMartinaSelectMedPlanTestDataMartinaSelectMedPlanEnglish_def.js';
import tmpl from './testDataMartinaSelectMedPlanTestDataMartinaSelectMedPlanEnglish.html';
import tmpl_nds from './testDataMartinaSelectMedPlanTestDataMartinaSelectMedPlanEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testDataMartinaSelectMedPlanTestDataMartinaSelectMedPlanEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

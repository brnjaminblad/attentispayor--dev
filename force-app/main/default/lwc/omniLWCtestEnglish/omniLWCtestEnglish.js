...
import { OMNIDEF } from './omniLWCtestEnglish_def.js';
import tmpl from './omniLWCtestEnglish.html';
import tmpl_nds from './omniLWCtestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class omniLWCtestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

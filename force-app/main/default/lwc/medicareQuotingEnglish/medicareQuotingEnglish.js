...
import { OMNIDEF } from './medicareQuotingEnglish_def.js';
import tmpl from './medicareQuotingEnglish.html';
import tmpl_nds from './medicareQuotingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareQuotingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

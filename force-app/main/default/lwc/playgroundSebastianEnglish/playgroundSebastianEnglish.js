...
import { OMNIDEF } from './playgroundSebastianEnglish_def.js';
import tmpl from './playgroundSebastianEnglish.html';
import tmpl_nds from './playgroundSebastianEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class playgroundSebastianEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

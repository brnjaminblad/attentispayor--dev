...
export default class PlanCards2 extends OmniscriptBaseMixin(LightningElement) {
    ...
    btnCompare(event) {
        let cardid = event.target.dataset.id;
        //console.log(cardid);
        let compareArray = JSON.parse(JSON.stringify(this.plansOrdered));
        let count = 0;
        for (let i = 0; i < this.plansOrdered.length; i++) {
        ...
        if (this.plansOrdered[cardid]['btnCompareLabel'] == 'Add Up to 3 Plans to Compare' && count < 3) {
            compareArray[cardid]['btnCompareLabel'] = 'Added to Compare';
            console.log(compareArray)
        }
        if (this.plansOrdered[cardid]['btnCompareLabel'] == 'Added to Compare') {
            compareArray[cardid]['btnCompareLabel'] = 'Add Up to 3 Plans to Compare';
        }
        this.plansOrdered = compareArray;
        //console.log(JSON.stringify(this.plansOrdered));
    }

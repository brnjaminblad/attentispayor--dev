...
import { OMNIDEF } from './medicareGet_StartedEnglish_def.js';
import tmpl from './medicareGet_StartedEnglish.html';
import tmpl_nds from './medicareGet_StartedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareGet_StartedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

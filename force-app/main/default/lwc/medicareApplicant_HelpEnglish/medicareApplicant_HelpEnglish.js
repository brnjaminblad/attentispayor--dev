...
import { OMNIDEF } from './medicareApplicant_HelpEnglish_def.js';
import tmpl from './medicareApplicant_HelpEnglish.html';
import tmpl_nds from './medicareApplicant_HelpEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareApplicant_HelpEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

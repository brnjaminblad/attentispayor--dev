...
import { OMNIDEF } from './medicareSelectedPlansEnglish_def.js';
import tmpl from './medicareSelectedPlansEnglish.html';
import tmpl_nds from './medicareSelectedPlansEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareSelectedPlansEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

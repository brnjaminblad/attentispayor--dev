...
import { OMNIDEF } from './vpl232ProviderRegistrationWorkflowEnglish_def.js';
import tmpl from './vpl232ProviderRegistrationWorkflowEnglish.html';
import tmpl_nds from './vpl232ProviderRegistrationWorkflowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vpl232ProviderRegistrationWorkflowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

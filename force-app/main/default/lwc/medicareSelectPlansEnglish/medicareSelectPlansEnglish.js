...
import { OMNIDEF } from './medicareSelectPlansEnglish_def.js';
import tmpl from './medicareSelectPlansEnglish.html';
import tmpl_nds from './medicareSelectPlansEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareSelectPlansEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

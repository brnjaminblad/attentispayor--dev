...
import { OMNIDEF } from './martinaImportantInformationMartinaConsumerMedicareEnglish_def.js';
import tmpl from './martinaImportantInformationMartinaConsumerMedicareEnglish.html';
import tmpl_nds from './martinaImportantInformationMartinaConsumerMedicareEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class martinaImportantInformationMartinaConsumerMedicareEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './pBMQuoteEnglish_def.js';
import tmpl from './pBMQuoteEnglish.html';
import tmpl_nds from './pBMQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pBMQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './medicareTESTQuotingTESTEnglish_def.js';
import tmpl from './medicareTESTQuotingTESTEnglish.html';
import tmpl_nds from './medicareTESTQuotingTESTEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareTESTQuotingTESTEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

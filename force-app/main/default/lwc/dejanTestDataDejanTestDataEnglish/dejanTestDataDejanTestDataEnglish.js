...
import { OMNIDEF } from './dejanTestDataDejanTestDataEnglish_def.js';
import tmpl from './dejanTestDataDejanTestDataEnglish.html';
import tmpl_nds from './dejanTestDataDejanTestDataEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dejanTestDataDejanTestDataEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

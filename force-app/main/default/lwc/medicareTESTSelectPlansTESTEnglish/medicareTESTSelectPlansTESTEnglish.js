...
import { OMNIDEF } from './medicareTESTSelectPlansTESTEnglish_def.js';
import tmpl from './medicareTESTSelectPlansTESTEnglish.html';
import tmpl_nds from './medicareTESTSelectPlansTESTEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class medicareTESTSelectPlansTESTEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;

...
import { OMNIDEF } from './joshTestingGetStartedEnglish_def.js';
import tmpl from './joshTestingGetStartedEnglish.html';
import tmpl_nds from './joshTestingGetStartedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class joshTestingGetStartedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
